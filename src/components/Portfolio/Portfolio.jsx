...
function Portfolio() {
    ...
    const handleClick = () => {
        setData((p) => [...p, ...extractedDataArray.slice(10)]);
    ...
    return (
        <div className="Portfolio">
            <div className="portfolio-header">
                ...
                <p>
                    Automation is made easier with Koders. Take a look at the
                    various projects we've completed
                </p>
            </div>
            ...
            <div className="portfolio-buttons">
                <button
                    className="portfolio-viewmore-btn"
                    onClick={handleClick}
                >
                    view more
                </button>
